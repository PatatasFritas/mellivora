...
CREATE TABLE challenges (
  ...
  dynamic_score tinyint(1) unsigned NOT NULL DEFAULT '0',
  dyn_max_points int(10) unsigned NOT NULL DEFAULT '500',
  dyn_min_points int(10) unsigned NOT NULL DEFAULT '50',
  dyn_threshold int(10) unsigned NOT NULL DEFAULT '25',
